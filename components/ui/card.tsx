...
function Card({
  ...
  return (
    <div
      ...
      data-size={size}
      className={cn(
        // No-Line Rule: no border/ring here to define the card's edge — the
        // `bg-card` tonal shift against the surface behind it is the boundary.
...
function CardFooter({ className, ...props }: React.ComponentProps<"div">) {
  return (
    <div
      ...
      className={cn(
        // No-Line Rule: the footer reads as distinct via the bg-muted/50
        // tonal shift, not a border line.
